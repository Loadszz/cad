				...
				<div className='relative'>
					...
					<div>
						...
						<div className='w-full flex flex-col items-end tb:mb-[40px]'>
							...
							<div className='flex justify-end items-start w-[50%] tb:w-full'>
								<div className='advantage-item-icon flex items-center justify-center flex-[0_0_118px] lp:flex-[0_0_100px] tb:flex-[0_0_60px] h-[118px] lp:h-[100px] tb:h-[60px] mr-[40px] tb:mr-[12px] ml-[40px]'>
								...
								<div className='flex-[1_1_auto]'>
									<h3 className='advantage-item-title max-w-[464px] mb-[24px] tb:mb-[12px]'>{t('advantages.item-title-third')}</h3>
						...
						<div className='w-full flex flex-col items-start tb:mb-[40px]'>
							<div className='flex items-center tb:flex-row-reverse w-[50%] tb:w-full mb-[32px] lp:mb-[20px] group'>
								{/* circle */}
								<div className='advantage-circle-number mr-[30px] tb:ml-[30px] tb:mr-0'>04</div>
								<div className='border border-dashed border-[#919191] w-[100%]'></div>
								<div className="advantage-circle-icon relative right-[-20px] lp:right-[-15px] tb:left-[-11px] z-10 group-hover:bg-cyan-400 transition-all duration-300">
									<div className='absolute top-[50%] translate-y-[-50%] left-[50%] translate-x-[-50%] rounded-[350px] h-[20px] lp:h-[15px] w-[20px] lp:w-[15px] bg-white'></div>
								</div>
							...
							<div className='flex justify-end items-start w-[50%] tb:w-full'>
								<div className='advantage-item-icon flex items-center justify-center flex-[0_0_118px] lp:flex-[0_0_100px] tb:flex-[0_0_60px] h-[118px] lp:h-[100px] tb:h-[60px] mr-[40px] tb:mr-[12px] tb:ml-[40px]'>
								...
								<div className='flex-[1_1_auto] mr-[40px] tb:mr-0'>
									<h3 className='advantage-item-title max-w-[464px] mb-[24px] tb:mb-[12px]'>{t('advantages.item-title-fourth')}</h3>
						...
						<div className='w-full flex flex-col items-end tb:mb-[40px]'>
							...
							<div className='flex justify-end items-start w-[50%] tb:w-full'>
								<div className='advantage-item-icon icon-advantages-file-earmark-medical flex items-center justify-center flex-[0_0_118px] lp:flex-[0_0_100px] tb:flex-[0_0_60px] h-[118px] lp:h-[100px] tb:h-[60px] mr-[40px] tb:mr-[12px] ml-[40px]'></div>
								<div className='flex-[1_1_auto]'>
									<h3 className='advantage-item-title max-w-[464px] mb-[24px] tb:mb-[12px]'>{t('advantages.item-title-fifth')}</h3>
						...
						<div className='w-full flex flex-col items-start tb:mb-[40px]'>
							<div className='flex items-center tb:flex-row-reverse w-[50%] tb:w-full mb-[32px] lp:mb-[20px] group'>
								{/* circle */}
								<div className='advantage-circle-number mr-[30px] tb:ml-[30px] tb:mr-0'>06</div>
								<div className='border border-dashed border-[#919191] w-[100%]'></div>
								<div className="advantage-circle-icon relative right-[-20px] lp:right-[-15px] tb:left-[-11px] z-10 group-hover:bg-cyan-400 transition-all duration-300">
									<div className='absolute top-[50%] translate-y-[-50%] left-[50%] translate-x-[-50%] rounded-[350px] h-[20px] lp:h-[15px] w-[20px] lp:w-[15px] bg-white'></div>
								</div>
							...
							<div className='flex justify-end items-start w-[50%] tb:w-full'>
								<div className='advantage-item-icon icon-advantages-check-circle flex items-center justify-center flex-[0_0_118px] lp:flex-[0_0_100px] tb:flex-[0_0_60px] h-[118px] lp:h-[100px] tb:h-[60px] mr-[40px] tb:mr-[12px] tb:ml-[40px]'></div>
								<div className='flex-[1_1_auto] mr-[40px] tb:mr-0'>
									<h3 className='advantage-item-title max-w-[464px] mb-[24px] tb:mb-[12px]'>{t('advantages.item-title-sixth')}</h3>
						...
						<div className='w-full flex flex-col items-end tb:mb-[40px]'>
							...
							<div className='flex justify-end items-start w-[50%] tb:w-full'>
								<div className='advantage-item-icon icon-advantages-chat-left-dots flex items-center justify-center flex-[0_0_118px] lp:flex-[0_0_100px] tb:flex-[0_0_60px] h-[118px] lp:h-[100px] tb:h-[60px] mr-[40px] tb:mr-[12px] ml-[40px]'></div>
								<div className='flex-[1_1_auto]'>
									<h3 className='advantage-item-title max-w-[464px] mb-[24px] tb:mb-[12px]'>{t('advantages.item-title-seven')}</h3>
