		...
		<header className={`absolute w-full py-[18px] z-10 transition-all duration-300 ${isOpen ? 'bg-cyan-300' : ''}`}>
			<div className="wrapper">
				<div className='flex justify-between items-center'>
					...
					<div class={`flex justify-between items-center w-full lp:absolute lp:flex-col lp:items-start lp:top-0 lp:w-full lp:h-[100vh] lp:justify-stretch lp:bg-black lp:mt-[113px] lp:pt-[60px] lp:pl-[32px] tb:pl-[20px] transition-all duration-300 ${isOpen ? 'lp:left-0' : 'lp:left-[-100%]'}`}>
