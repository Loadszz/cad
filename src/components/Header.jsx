		...
		<header className='absolute w-full py-[18px] z-10'>
			<div className="wrapper">
				<div className='flex justify-between items-center'>
					...
					<div class={`flex justify-between items-center w-full lp:absolute lp:flex-col lp:items-start lp:top-0 lp:w-full lp:h-[100vh] lp:justify-stretch lp:bg-black lp:pt-[156px] lp:pl-[32px] tb:pl-[20px] transition-all duration-300 ${isOpen ? 'lp:left-0' : 'lp:left-[-100%]'}`}>
						<div className='invisible lp:visible lp:absolute lp:left-0 lp:top-0 lp:bg-lol lp:bg-center lp:bg-no-repeat lp:bg-cover lp:w-full lp:h-full'></div>
						<Nav className='flex justify-center gap-[32px] lp:flex-col lp:justify-stretch lp:gap-[48px] lp:mb-[220px] tb:gap-[28px] tb:mb-[312px]' />
						<LanguageSwitcher />
					</div>
				</div>
			</div>
